...
#include "api.h"
  ...
  static const NFFT_INT m2K_[] = {0};
#elif defined(GAUSSIAN)
  static const NFFT_INT m2K_[] = {0, 1, 3, 6, 7, 9, 11, 13, 15, 17, 19, 21, 22, 23, 24};
#elif defined(B_SPLINE)
  static const NFFT_INT m2K_[] = {0, 0, 4, 7, 10, 13, 15, 17, 19, 22, 24};
#elif defined(SINC_POWER)
  static const NFFT_INT m2K_[] = {0, 0, 2, 5, 8, 11, 12, 14, 16, 18, 21, 23, 24, 24};
#else /* Kaiser-Bessel is the default. */
  static const NFFT_INT m2K_[] = {1, 3, 7, 9, 14, 17, 20, 23, 24};
#endif
